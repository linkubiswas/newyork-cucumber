...
public class Home extends NavigationBar{
    ...
    private final By LoneAmountInputField = By.id("loanamt");
    private final By InterestRateInputField = By.id("intrstsrate");
    private final By LoneTermInputField = By.id("loanterm");
    private final By StartMonthDropDown = By.name("param[start_month]");
    private final By StartYearsInputField = By.id("start_year");
    ...
    private final By LoneTypeDropDown = By.name("param[milserve]");
    ...
    public Home typeLoanAmount(String value){
        ...
        ActOn.element(driver,LoneAmountInputField).setValue(value);
        return this;
    }
    ...
    public Home typeLoanTermYears(String value){
        ...
        ActOn.element(driver,LoneTermInputField).setValue(value);
        return this;
    }
    ...
    public Home typeYear(String year){
        ...
        ActOn.element(driver,StartYearsInputField).setValue(year);
        return this;
    }
    ...
    public Home selectLoanType(String value){
        ...
        ActOn.element(driver,LoneTypeDropDown).selectValue(value);
        return this;
    }
